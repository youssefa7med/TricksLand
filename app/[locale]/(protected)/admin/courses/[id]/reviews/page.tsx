...
import { Star, User, Calendar, Clock, MessageSquare, ChevronLeft, FileText, ChevronRight } from 'lucide-react';
...
export default function AdminCourseReviewsPage() {
    ...
    const getResponseCount = (review: Review) => {
