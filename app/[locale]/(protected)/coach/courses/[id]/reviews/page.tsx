...
import { Star, Calendar, Clock, MessageSquare, ChevronLeft, FileText, ChevronRight } from 'lucide-react';
                            ...
                            >
                                <div className="flex items-center justify-between gap-4">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {review.review_text && (
                                            <p className="text-white/50 text-xs truncate mt-0.5">{review.review_text}</p>
                                        )}
                                    </div>
